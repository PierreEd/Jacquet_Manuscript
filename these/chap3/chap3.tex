...
The transfer matrix for a single sideband from a detuned single port cavity is given by
\begin{equation*}
...
\begin{equation}
    \phi_{\mathrm{fc}}[\Omega] = \arctan \left(\dfrac{2 \Delta \kappa }{\kappa^2/4 - \Delta^2 + \Omega^2}\right) 
\end{equation}
