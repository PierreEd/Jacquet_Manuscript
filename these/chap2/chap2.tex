...
\end{equation}.
where we wrote the complex reflectivities as $r_{\Delta}[\Omega] = r_+ e^{i \phi_+}$ and $r_{\Delta}^*[-\Omega] = r_- e^{-i \phi_-}$ and we use the usual transformation for the positive and negative sideband reflectivities as
\begin{equation}
\begin{split}
