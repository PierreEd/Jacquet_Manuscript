...
\caption{Landmark examples of the four main categories of research in quantum optomechanics: (I) the study of quantum limits in position measurements: the first experimental demonstration of radiation-pressure noise in tabletop optomechanics \cite{regal2013}; (II) the investigation of the fundamental quantum physics of the mechanical degree of freedom: the setup used to probe mechanical sideband asymmetry close to the membrane ground state \cite{Lee2015}; (III) the development of improved optomechanical sensors: demonstration of optomechanically enhanced force microscopes \cite{Halg2021}; and (IV) applications to quantum information: demonstration of optical to microwave transduction \cite{Andrews2014}. All these examples involve membrane based resonators, which have become a popular platform for optomechanics due to their versatility and tunability.}
\label{fig:panorama}
\end{figure}
\endgroup 
