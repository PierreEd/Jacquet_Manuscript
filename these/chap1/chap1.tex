...
\caption{Non-exhaustive overview of mechanical resonators used in free-space optomechanics experiments. From left to right: a fg-scale nanosphere levitated in an optical tweezer \cite{delic2020}, (b) a pg-scale nanowire \cite{Arcizet}, (c) ng-scale membrane based resonators (plane membranes, a trampoline resonator, a strip and a phononic crystal membrane) \cite{norcada,?, Norte2016StripMembrane, Tsaturyan2017PhononicCrystalMembrane}, (d) $\mu$g-scale \textit{wheel} reosnator \cite{Marin} and } 
