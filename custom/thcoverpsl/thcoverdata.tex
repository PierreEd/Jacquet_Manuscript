...
\gradename{docteur}
\univ{ de l'Université de recherche Paris Sciences et Lettres\\  PSL Research University}
\logos{tintin}{}{}                   % Un à trois logo. Le 1er est celui de \univ
\specialite{Physique}
\ecoledoctnum{564}
...
\jury{ %for PSL keep breaklines and &  alignment characters                 
M. & Alfredo TOPOLINO \\ &Université de Genève, Rapporteur    \\
M. & Fan SE-YENG  \\ &Université de Shangaï, Rapporteur  \\
M. & Séraphin LAMPION \\ &Agent d’assurances, Invité\\
...
\par\hfill  (1700 car max, espaces inclus)}
